      ...
      <ul class="nav navbar-nav">
				...
				<?php
					if (isset($_SESSION['username'])) {
						...
						if ($include_file=='wallet') {
							echo '<li class="dropdown active">';
						} else {
							echo '<li class="dropdown">';
						}
						echo '<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">'.lang('WALLET_WALLET').' <span class="caret"></span></a>
						  <ul class="dropdown-menu">
							<li><a href="/wallet"><i class="fa fa-university"></i> '.lang('OVERVIEW_OVERVIEW').'</a></li>
							<li><a href="/wallet/transactions"><i class="fa fa-list"></i> '.lang('TRANSACTIONS_TRANSACTIONS').'</a></li>
							<li><a href="/wallet/addressbook"><i class="fa fa-book"></i> '.lang('ADDRESS_BOOK').'</a></li>
							<li><a href="/wallet/send"><i class="fa fa-arrow-circle-o-right"></i> '.lang('SEND_SEND').'</a></li>
							<li><a href="/wallet/receive"><i class="fa fa-arrow-circle-o-down"></i> '.lang('RECEIVE_RECEIVE').'</a></li>
							<li><a href="/wallet/nvs"><i class="fa fa-list-alt"></i> '.lang('NVS_NVS').'</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="/wallet/settings"><i class="fa fa-gear"></i> '.lang('SETTINGS_SETTINGS').'</a></li>
							<li role="separator" class="divider"></li>
							<li><a id="logout"><i class="fa fa-power-off"></i> '.lang('LOGOUT_LOGOUT').' ('.$username.')</a></li>
						  </ul>
						</li>';
					} else {
						if ($include_file=='wallet') {
							echo '<li class="active"><a href="/wallet">'.lang('WALLET_WALLET').'</a></li>';
						} else {
							echo '<li><a href="/wallet">'.lang('WALLET_WALLET').'</a></li>';
						}
					}
				?>
			</ul>
